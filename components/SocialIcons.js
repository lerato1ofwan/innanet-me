            ...
            :
                <div className={`${styles[`social-links`]} ${styles[`${isHome}`]}`}>
                    <ul className={styles.slinks}>
                        <li><a className={styles.slinks} target="_blank" href="https://www.github.com/lerato1ofone" rel="noopener noreferrer"><Image className={styles.icon} src="/icons/github.svg" alt="github" width="25" height="25"/></a></li>
                        <li><a className={styles.slinks} target="_blank" href="https://www.twitter.com/lerato1ofone" rel="noopener noreferrer"><Image className={styles.icon} src="/icons/twitter.svg" alt="twitter" width="25" height="25"/></a></li>
